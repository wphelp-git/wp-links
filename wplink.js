...
(function($, wpLinkL10n, wp) {
  ...
  window.wpLink = {
      ...
      if (wpLink.isMCE()) {
        ...
        if (document.selection) {
          ...
          text = this.textarea.value.substring(this.textarea.selectionStart,
              this.textarea.selectionEnd) || text || '';
        }
    ...
    mceRefresh: function(searchStr, text) {
      ...
      if (linkNode.length) {
        ...
        if (searchStr && searchStr !== href) {
          // The user has typed something in the inline dialog. Trigger a
          // search with it.
    ...
    htmlUpdate: function() {
      ...
      // Audible confirmation message when a link has been inserted in the
      // Editor.
      ...
      editor.undoManager.transact(function() {
        if (!$link.length) {
          editor.execCommand('mceInsertLink', false,
              {href: '_wp_link_placeholder', 'data-wp-temp-link': 1});
